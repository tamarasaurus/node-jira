...
(function() {
  ...
  this.findRapidView = function(callback) {
  ...
  this.getLastSprintForRapidView = function(rapidViewId, callback) {
    ...
    var options = {
      rejectUnauthorized: this.strictSSL,
      uri: this.makeUri('/sprints/' + rapidViewId, 'rest/greenhopper/', '1.0'),
      method: 'GET',
      json: true
    };
  ...
  this.getUsersIssues = function(username, params, open, callback) {
    ...
    this.searchJira(jql, {
      maxResults: 1000,
      fields: ["summary", "status", "issuetype", "assignee", "description", "created", "reporter", "priority", "sprint"]
    }, callback);
  };
